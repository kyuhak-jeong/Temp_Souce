...
} SAN_GPIO_HANDLE_INFO;

SAN_GPIO_HANDLE SAN_GpioInit( int32_t nGpio )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
	...
	// create handle.
	pInfo = (SAN_GPIO_HANDLE_INFO*)malloc( sizeof(SAN_GPIO_HANDLE_INFO) );
	...
	return (SAN_GPIO_HANDLE_INFO*)pInfo;
}

void	SAN_GpioDeinit( SAN_GPIO_HANDLE hGpio )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
	...
	assert(hGpio);
	pInfo = (SAN_GPIO_HANDLE_INFO*)hGpio;
...
int32_t	SAN_GpioDirection( SAN_GPIO_HANDLE hGpio, int32_t direction )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
...
int32_t	SAN_GpioSetValue( SAN_GPIO_HANDLE hGpio, int32_t value )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
...
int32_t	SAN_GpioGetValue( SAN_GPIO_HANDLE hGpio )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
...
int32_t SAN_GPioSetEdge( SAN_GPIO_HANDLE hGpio, int32_t edge )
{
	int32_t fd = 0, len = 0;
	SAN_GPIO_HANDLE_INFO	*pInfo;
	char buf[64];
...
int32_t SAN_GpioGetInterrupt( SAN_GPIO_HANDLE hGpio )
{
	SAN_GPIO_HANDLE_INFO	*pInfo;
...
int32_t SAN_GpioPostInterrupt( SAN_GPIO_HANDLE hGpio )
{
	SAN_GPIO_HANDLE_INFO	*pInfo;
